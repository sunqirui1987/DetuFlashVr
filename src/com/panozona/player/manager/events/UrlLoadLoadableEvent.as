...
package com.panozona.player.manager.events {
	...
	public class UrlLoadLoadableEvent extends Event {
		...
		public function UrlLoadLoadableEvent(eventType:String, loadable:ILoadable = null, content:DisplayObject = null) {
			super(eventType);
