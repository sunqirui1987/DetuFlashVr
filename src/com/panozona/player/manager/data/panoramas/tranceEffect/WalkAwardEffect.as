package com.panozona.player.manager.data.panoramas.tranceEffect
{
	 ...
	 * 功能描述:
	 */
	public class WalkAwardEffect extends Sprite
	{
		...
		public function WalkAwardEffect(manager:Manager,movePan:Number=0,endFun:Function=null)
		{
...
//						manager.stage.addChild(st);
			...
			Tweener.addTween(this,{time:0.6,onComplete:function():void{
				movetimes ++;
				if(movetimes <2 )
					movePoints();
				else
