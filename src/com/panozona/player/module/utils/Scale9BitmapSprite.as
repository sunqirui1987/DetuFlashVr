package com.panozona.player.module.utils
{
	...
	public class Scale9BitmapSprite extends Sprite
	{
		...
		public function Scale9BitmapSprite(bitmapData:BitmapData, scale9rect:Rectangle,
										   ...
										   colornumber:Number = 0x000000,
										   coloralpha:Number = 0.6)
		{
			...
			// MAIN RECTANGLE
			mainRectangle = createRectangle(sc,iscolor,colornumber,coloralpha);
		}
		...
		private function createRectangle(rect:Rectangle, iscolor:Boolean = false,
										 colornumber:Number = 0x000000,
										 coloralpha:Number = 0.6):Sprite	{
			var xPos:Number = rect.x;
			var yPos:Number = rect.y;
			var w:Number = rect.width;
			var h:Number = rect.height;	
			...
			{
				sprite.graphics.beginFill(colornumber,coloralpha);
			}
...
import com.panozona.modules.guide.utils;
