...
package com.panozona.modules.imagemap.controller {
	...
	public class CloseController {
		...
		public function CloseController(closeView:CloseView, module:Module){
			...
			if (_closeView.imageMapData.close.path == null) return;
			...
			imageLoader.load(new URLRequest(_closeView.imageMapData.close.path),new flash.system.LoaderContext(true));
		}
		...
		private function handleMouseClick(e:Event):void {
			_closeView.imageMapData.windowData.open = false;
		}
	}
}