...
package com.panozona.modules.buttonbar.controller{
	...
	public class WindowController{
		...
		private var swfViewController:SwfViewController;
		...
		public function WindowController(windowView:WindowView, module:Module) {
			...
			if(windowView.swfView){
				swfViewController = new SwfViewController(windowView.swfView, _module);
			}else{
				bgController = new BgController(windowView.bgView, _module);
				
				barController = new BarController(windowView.barView, _module);
			}
