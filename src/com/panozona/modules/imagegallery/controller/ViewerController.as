...
package com.panozona.modules.imagegallery.controller {
	...
	public class ViewerController {
		...
		public function ViewerController(viewerView:ViewerView, module:Module) {
			...
			buttonsLoader.load(new URLRequest(_viewerView.imagegalleryData.viewerData.viewer.path),new flash.system.LoaderContext(true));
		}
		
		private function onPanoramaLoaded(loadPanoramaEvent:Object):void {
			var panoramaEventClass:Class = ApplicationDomain.currentDomain.getDefinition("com.panozona.player.manager.events.PanoramaEvent") as Class;
			_module.qjPlayer.manager.removeEventListener(panoramaEventClass.PANORAMA_STARTED_LOADING, onPanoramaLoaded);
