...
package com.panozona.modules.imagegallery.controller{
	...
	public class WindowController{
		...
		private function handleResize(event:Event = null):void {
			...
			newSize.width = _module.qjPlayer.manager.boundsWidth 
			...
			newSize.height = _module.qjPlayer.manager.boundsHeight 
			...
			if (_windowView.windowData.window.align.horizontal == Align.LEFT) {
				...
				var tmpHorizontal:Number = (_module.qjPlayer.manager.boundsWidth - newSize.width) * 0.5;
				if (tmpHorizontal + newSize.width > _module.qjPlayer.manager.boundsWidth - _windowView.windowData.window.margin.right) {
					newMove.horizontal = (_module.qjPlayer.manager.boundsWidth - _windowView.windowData.window.margin.right) - (tmpHorizontal + newSize.width);
				}
			...
			if (_windowView.windowData.window.align.vertical == Align.TOP) {
				...
				var tmpVertical:Number = (_module.qjPlayer.manager.boundsHeight - newSize.height) * 0.5;
				if (tmpVertical + newSize.height > _module.qjPlayer.manager.boundsHeight - _windowView.windowData.window.margin.bottom) {
					newMove.vertical = (tmpVertical + newSize.height) - (_module.qjPlayer.manager.boundsHeight - _windowView.windowData.window.margin.bottom);
				}
