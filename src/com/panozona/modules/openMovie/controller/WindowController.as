...
package com.panozona.modules.openMovie.controller{
	...
	public class WindowController{
		...
		public function WindowController(openMoviewView:OpenMovieView, module:Module) {
			
			_module = module;
			_windowView = openMoviewView.windowView;
			...
			if (openMoviewView.openMovieData.setting.mouse.onOver != null && _windowView.movieObj) {
				_windowView.movieObj.addEventListener(MouseEvent.ROLL_OVER, getMouseEventHandler(openMoviewView.openMovieData.setting.mouse.onOver));
			}
			if (openMoviewView.openMovieData.setting.mouse.onOut != null && _windowView.movieObj) {
				_windowView.movieObj.addEventListener(MouseEvent.ROLL_OUT, getMouseEventHandler(openMoviewView.openMovieData.setting.mouse.onOut));
			}
